...
// Firebase is legacy and disabled unless every legacy variable is explicitly supplied.
// The production application uses Supabase; no Firebase fallback values are bundled.
